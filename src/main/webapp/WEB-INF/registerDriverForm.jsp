...
<%--        <img src="../images/driver-form.png" class="card-img-top" alt="...">--%>
        <a type="button" class="btn btn-outline-secondary btn-in-add" href="/drivers"><STRONG>&#8249;</STRONG> All drivers</a>
        <div class="card-body">
            ...
            <form method="POST" action="/add-driver">
                <div class="mb-3 form-holder">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Jhon" name="firstName" required>
                </div>
                <div class="mb-3 form-holder">
                    <label for="exampleFormControlInput2" class="form-label">Last Name</label>
                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Doe" name="lastName" required>
                </div>
<%--                <div class="mb-3">--%>
...
<%--                </div>--%>
                ...
                <div class="mb-3 form-holder">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput4" placeholder="name@example.com" name="email" required>
                </div>
                <div class="mb-3 form-holder">
                    <label for="exampleFormControlInput5" class="form-label">Contact Number</label>
                    <input type="tel" class="form-control" id="exampleFormControlInput5" placeholder="XXXXXXXXXX" pattern="[0-9]{10}" name="contactNumber" required>
                </div>
                <div class="mb-3 form-holder">
                    <label for="exampleFormControlInput6" class="form-label">UserID</label>
                    <input type="text" class="form-control" id="exampleFormControlInput6" placeholder="eg:d002211" pattern="[dD][0-9]{6}" name="driverId" required>
                </div>
                <p class="model-info text-muted"><i>(Password of driver will be the UserID in uppercase characters)</i></p>
                <div class="row g-2">
                <div class="col-auto form-holder">
                    <label for="exampleFormControlInput7" class="form-label">NIC number</label>
                    <input type="text" class="form-control" id="exampleFormControlInput7" placeholder="XXXXXXXXX v/x" name="NIC" pattern="[0-9]{9}[vV|xX]" required>
                </div>
                <div class="col-auto form-holder">
                    <label for="exampleFormControlInput8" class="form-label">Vehicle number</label>
                    <input type="text" class="form-control" id="exampleFormControlInput8" placeholder="ABC-1234" name="vehicleNumber" pattern="[a-zA-Z]{1,3}|((?!0*-)[0-9]{1,3}))-[0-9]{4}(?<!0{4})" required>
                </div>
                </div>
<%--                AP-05-BJ-9353--%>
<%--                TN-35-AB-638--%>
