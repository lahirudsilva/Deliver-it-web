        ...
        <div class="carousel-item active">
            ...
            <sec:authorize access="hasRole('SUPERVISOR')">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <a type="button" class="btn btn-outline-dark create-package" href="/"> On-going Shipments</a>
            ...
            <sec:authorize access="hasRole('DRIVER')">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <a type="button" class="btn btn-outline-dark create-package" href="/"> Check Rides</a>
