    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav1">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link ${param.page == "students" ? "active" : null}"
                   href="/students">Shipments</a>
                <a class="nav-item nav-link ${param.page == "classes" ? "active" : null}" href="/classes">Drivers</a>
                <a class="nav-item nav-link ${param.page == "rooms" ? "active" : null}" href="/rooms">Customers</a>
            </div>
        </div>
        </sec:authorize>
        ...
        <div class="collapse navbar-collapse" id="navbarNav2">
            <div class="navbar-nav">
                <a class="nav-item nav-link ${param.page == "home" ? "active" : null}" href="/">Home</a>
                <a class="nav-item nav-link ${param.page == "classes" ? "active" : null}" href="/classes">Tracking</a>
                <a class="nav-item nav-link ${param.page == "students" ? "active" : null}"
